# vsock-parent-global.py
# usage ex: python3 vsock-parent-global.py server 5005
# (in a new terminal): python3 vsock-parent-global.py client 16 5006 (16 is the enclave CID)
